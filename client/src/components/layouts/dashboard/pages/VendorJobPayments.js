...
import { getVendorJobPayments } from "./../../../../actions/paymentActions";

class VendorJobPayments extends Component {

	componentDidMount() {
		const { user } = this.props.auth;
		this.props.getCurrentUser( user );
		this.props.getVendorJobPayments();
	}
...
VendorJobPayments.propTypes = {
	getCurrentUser: PropTypes.func.isRequired,
	getVendorJobPayments: PropTypes.func.isRequired,
...
export default connect( mapStateToProps, { getCurrentUser, getVendorJobPayments } )( VendorJobPayments );